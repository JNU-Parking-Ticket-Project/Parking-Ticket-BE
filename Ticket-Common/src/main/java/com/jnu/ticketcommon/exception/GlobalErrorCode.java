...
public enum GlobalErrorCode implements BaseErrorCode {
    ...
    MULTI_EXCEPTION(INTERNAL_SERVER, "GLOBAL_400_2", "여러 오류가 발생했습니다."),
    ...
    TITLE_MUST_NOT_BLANK(BAD_REQUEST, "BAD_REQUEST", ValidationMessage.TITLE_MUST_NOT_BLANK),
    DATE_MUST_NOT_NULL(BAD_REQUEST, "BAD_REQUEST", ValidationMessage.DATE_MUST_NOT_NULL),
