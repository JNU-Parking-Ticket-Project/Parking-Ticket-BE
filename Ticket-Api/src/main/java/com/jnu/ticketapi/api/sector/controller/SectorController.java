...
import com.jnu.ticketapi.common.aop.SectorNumCheck;
...
public class SectorController {
    ...
    @ApiErrorExceptionsExample(CreateSectorExceptionDocs.class)
    @PutMapping("/sectors")
    public SuccessResponse updateEvent(@RequestBody @SectorNumCheck List<@Valid SectorRegisterRequest> sectors) {
