...
public class FinalSaveExceptionDocs implements SwaggerExampleExceptions {
    ...
    @ExplainError("Redis를 사용하지 않는 scale-down 환경이거나 이벤트 OPEN 초기화 전인 경우")
    public TicketCodeException Redis_재고_처리가_불가능한_경우 = RedisStockUnavailableException.EXCEPTION;
